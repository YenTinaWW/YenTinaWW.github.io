...
const Blog = () => {
  ...
  const content = {
    en: { title: "Technical", subtitle: "Notes & Learning", readMore: "Read Article", empty: "Coming soon..." },
    zh: { title: "技術筆記", subtitle: "與學習心得", readMore: "閱讀文章", empty: "文章準備中..." }
  };
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', maxWidth: '800px', margin: '0 auto' }}>
        {posts.length === 0 ? (
          <div className="glass-card" style={{ padding: '4rem 2rem', textAlign: 'center', color: 'var(--text-secondary)' }}>
            <p style={{ fontSize: '1.2rem' }}>{content[lang].empty}</p>
          </div>
        ) : (
          posts.map(post => (
